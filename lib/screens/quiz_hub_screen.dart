      ...
      body: Padding(
        ...
        child: Column(
          children: [
            _HubCard(
              title: 'Dashboard',
              subtitle: 'Review drafts, past quizzes, and performance summaries.',
...
class _HubCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color border = theme.dividerColor.withValues(alpha: isDark ? 0.4 : 0.2);
    final Color subtitleColor = theme.colorScheme.onSurface.withValues(alpha: 0.65);
